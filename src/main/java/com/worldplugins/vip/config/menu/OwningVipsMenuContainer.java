...
@MenuContainerSpec(name = "vips_secondarios")
public class OwningVipsMenuContainer implements InjectedMenuContainer {
    public @NonNull MenuData createData(@NonNull ConfigurationSection section) {
        return MenuDataUtils.fetch(section)
            ...
            .modifyData(dataSection -> new HashMap<String, Object>() {{
                ...
                put("Display-vip", dataSection.itemDisplay("Display-vip"));
            }})
            .build();
    }
}
